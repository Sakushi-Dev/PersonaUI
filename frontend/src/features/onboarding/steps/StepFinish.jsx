    ...
    <div className={styles.card}>
      {hasApiKey ? (
        ...
        <div className={styles.finishCard}>
          ...
          <h2 className={styles.finishTitle}>{s.titleDone}</h2>
          <p className={styles.finishText}>{s.textDone}</p>

          <p className={styles.finishHint}>{s.hintDone}</p>
          <button
        ...
        <div className={styles.finishCard}>
          <div className={styles.finishIconBounce}>➜</div>
          <h2 className={styles.finishTitle}>{s.titleExplore}</h2>
          <p className={styles.finishText} dangerouslySetInnerHTML={{ __html: s.textExplore }} />
          <p className={styles.finishHint}>{s.hintExplore}</p>
