...
// All icons: 24×24 viewBox, inherit size via props, stroke="currentColor"

const defaults = { fill: 'none', stroke: 'currentColor', strokeWidth: '1.8', strokeLinecap: 'round', strokeLinejoin: 'round' };

export function SoundOnIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...defaults} strokeWidth="2">
...
export function CortexIcon({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...defaults}>
...
export function PersonaIcon({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...defaults}>
...
// ── Additional icons for overlay headers ──
...
export function SmartphoneIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...defaults}>
...
export function BugIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...defaults}>
      <circle cx="12" cy="12" r="10" />
