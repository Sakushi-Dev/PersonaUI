...
def _flatten_defaults():
    ...
    # Theme
    flat['backgroundColorDark'] = theme.get('backgroundColorDark', '#1a2332')
    flat['backgroundColorLight'] = theme.get('backgroundColorLight', '#a3baff')
    flat['secondaryColorDark'] = theme.get('secondaryColorDark', '#3d4f66')
    flat['secondaryColorLight'] = theme.get('secondaryColorLight', '#fd91ee')
    flat['gradientColor1Dark'] = theme.get('gradientColor1Dark', '#2a3f5f')
